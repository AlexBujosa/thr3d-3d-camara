...
export class BoxGeometry extends Geometry {
    ...
    renderObject(camera) {
        ...
        for (let index = 0; index < this.faces.length; index++) {
            ...
            ctx.beginPath();
            ctx.moveTo(deltaXP1 * (dLine / deltaZP1), deltaYP1 * (dLine / deltaZP1) + this.height * 0.5);
            ctx.lineTo(deltaXP2 * (dLine / deltaZP2) + this.width * 0.5, deltaYP2 * (dLine / deltaZP2) + this.height * 0.5);
            ctx.lineTo(deltaXP3 * (dLine / deltaZP3) + this.width * 0.5, deltaYP3 * (dLine / deltaZP3) + this.height * 0.5);
            ctx.lineTo(deltaXP4 * (dLine / deltaZP4) + this.width * 0.5, deltaYP4 * (dLine / deltaZP4) + this.height * 0.5);
            ctx.lineTo(deltaXP1 * (dLine / deltaZP1) + this.width * 0.5, deltaYP1 * (dLine / deltaZP1) + this.height * 0.5);
...
export class Camera {
    ...
    setAngles(angTetha = 0, angAlpha = 0) {
